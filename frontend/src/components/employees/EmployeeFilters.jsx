...
function EmployeeFilters({
  ...
  return (
    <div
      data-aos="fade-up"
      className="bg-white dark:bg-[#2d2d30] p-4 sm:p-5 rounded-2xl border border-slate-200 dark:border-[#3e3e42] mb-5 shadow-sm"
    >
      <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 items-stretch sm:items-end">
        {/* Search Input */}
        <div className="flex flex-col gap-1.5 w-full sm:flex-[2_1_240px]">
        ...
        {/* Department & Status Filters Row */}
        <div className="flex gap-3 sm:gap-4 w-full sm:w-auto sm:contents">
          {/* Department Filter */}
          <div className="flex flex-col gap-1.5 flex-1 sm:flex-[1_1_180px]">
          ...
          {/* Status Filter */}
          <div className="flex flex-col gap-1.5 flex-1 sm:flex-[1_1_150px]">
        ...
        <div className="flex gap-3 sm:gap-4 w-full sm:w-auto sm:contents">
          ...
          {hasActiveFilters && (
            <div className="flex flex-col gap-1.5 flex-none justify-end">
              <label className="text-xs font-bold uppercase invisible hidden sm:block">Clear</label>
              <button
                onClick={onClearFilters}
                className="flex items-center justify-center gap-1.5 px-4 py-2.5 bg-slate-200 dark:bg-[#3e3e42] text-slate-800 dark:text-white hover:bg-slate-300 dark:hover:bg-[#4e4e52] rounded-xl text-sm font-semibold transition-colors"
                type="button"
              >
                <X className="w-4 h-4" />
                Clear Filters
          ...
          {onAddEmployee && (
            <div className="flex flex-col gap-1.5 flex-1 sm:flex-none sm:ml-auto justify-end">
              <label className="text-xs font-bold uppercase invisible hidden sm:block">Action</label>
              <button
                onClick={onAddEmployee}
                className="flex items-center justify-center gap-2 px-5 py-2.5 bg-[#007acc] hover:bg-[#005fb8] text-white font-bold text-sm rounded-xl shadow-sm transition-colors whitespace-nowrap w-full sm:w-auto"
                type="button"
              >
