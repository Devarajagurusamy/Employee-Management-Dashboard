...
function EmployeeTable({
  ...
  if (loading) {
    return (
      <div className="p-14 text-center bg-white dark:bg-[#2d2d30] rounded-2xl border border-slate-200 dark:border-[#3e3e42] shadow-sm">
  ...
  return (
    <div
      data-aos="fade-up"
      className="w-full overflow-x-auto rounded-2xl border border-slate-200 dark:border-[#3e3e42] bg-white dark:bg-[#2d2d30] shadow-sm"
    >
